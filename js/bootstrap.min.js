...
function drawChart(){var e=google.visualization.arrayToDataTable([["Person","Without exercise","With exercise"],["Spencer Alan Watson",40.74,23.67],["Marissa Wekesser",12.23,8.23]]);var t={title:"Time taken to change Bromythol to yellow-green",hAxis:{title:"Person",titleTextStyle:{color:"red"}},vAxis:{title:"Seconds",titleTextStyle:{color:"red"}},height:500,width:800};var n=new google.visualization.ColumnChart(document.getElementById("ColumnChart"));n.draw(e,t)}$(document).ready(function(){if(location.hash!=""){var e=$("#myTab a");for(var t=0;t<e.length;t++){if(e[t].href.indexOf(location.hash)!=-1){$(e[t]).tab("show")}}$('<a href="'+location.hash+'">').tab("show")}$("#myTab a").click(function(e){e.preventDefault();$(this).tab("show");location.hash=e.target.hash})});google.load("visualization","1",{packages:["corechart"]});google.setOnLoadCallback(drawChart)